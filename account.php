...
$dashboardUrl = isAdmin() ? 'admin/dashboard.php' : 'employee/dashboard.php';
?>
...
<main class="main-content">
	...
	<div class="form-container">
        ...
        <div class="profile-section">
            <div class="profile-preview" style="position: relative !important; overflow: hidden !important; display: flex !important; align-items: center !important; justify-content: center !important; width: 100px !important; height: 100px !important; min-width: 100px !important; min-height: 100px !important; max-width: 100px !important; max-height: 100px !important; aspect-ratio: 1/1 !important; border-radius: 50% !important; flex-shrink: 0 !important;">
                <i class="bi bi-person-fill" style="font-size: 48px; color: #9ca3af;"></i>
                <?php if (!empty($user['profile_photo'])): ?>
                    <img src="<?= htmlspecialchars($user['profile_photo']) ?>" alt="Profile Photo" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; border-radius: 50% !important;" onerror="this.remove();">
                <?php endif; ?>
            </div>
            <div style="flex:1;">
        ...
        <!-- Full Name Update Section -->
        <div class="profile-section" style="margin-top: 20px;">
            <div style="width: 100%;">
                <h3 style="margin:0 0 8px; font-size:18px;">Change Full Name</h3>
                <p style="margin:0 0 16px; color:#6b7280; font-size:14px;">Update your display name. This will appear on all vouchers.</p>
