<?php
/**
 * React shell for Company Management.
...
<head>
    ...
    <?php endif; ?>
    <script>
      window.__MANAGEMENT_CFG__ = <?= $cfgJson ?>;
    </script>
</head>
<body class="dashboard page-exp-desk page-company-management">
...
<main class="main-content exp-desk-react-root">
    <noscript>
        <div style="padding:1rem;border:1px solid #fecaca;background:#fef2f2;color:#991b1b;border-radius:10px;">
            ...
            <p style="margin:0.35rem 0 0;">Enable JavaScript to view company management.</p>
        </div>
    </noscript>
    <div id="root"></div>
</main>
