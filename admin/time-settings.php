...
/**
 * ERP entry for Time & Format — erp-laravel Domains/Admin + React UI.
 * URL: /{company}/admin/time-settings.php?module=settings
 */
...
$GLOBALS['ERP_ROUTE'] = '/admin/desk/time-settings';
