...
/**
 * ERP entry for WhatsApp Configuration — erp-laravel Domains/Admin + React UI.
 * URL: /{company}/admin/whatsapp-settings.php?module=settings
 */
...
$GLOBALS['ERP_ROUTE'] = '/admin/desk/whatsapp-settings';
