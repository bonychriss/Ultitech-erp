<?php
/**
 * Attendance settings — React shell.
 * URL: /attendance/settings.php?module=attendance
 *      /{slug}/attendance/settings.php?module=attendance
 */
...
require_once $publicHtmlRoot . '/attendance/lib.php';
requireAdmin();
...
$jsPath = $publicHtmlRoot . '/attendance/attendance-ui/dist/assets/attendance-ui.js';
$cssPath = $publicHtmlRoot . '/attendance/attendance-ui/dist/assets/attendance-ui.css';
...
if (!$built) {
    ...
    echo '<!DOCTYPE html><html><head><title>Attendance Settings</title></head><body style="font-family:sans-serif;padding:2rem;">';
    echo '<h1>Attendance Settings</h1>';
...
<head>
    ...
    <title><?= htmlspecialchars($page_title) ?> - <?= htmlspecialchars(defined('COMPANY_NAME') ? COMPANY_NAME : 'ERP') ?></title>
    <script>
    (function() {
...
<?php include $publicHtmlRoot . '/includes/header_employee.php'; ?>
...
<main class="main-content att-desk-react-root" role="main">
    <noscript>
        <div style="padding:1rem;border:1px solid #fecaca;background:#fef2f2;color:#991b1b;border-radius:10px;">
            ...
            <p style="margin:0.35rem 0 0;">Enable JavaScript to use Attendance Settings.</p>
        </div>
    </noscript>
    <div id="root">
        <div class="att-desk-boot-loading" role="status" aria-live="polite">Loading settings…</div>
    </div>
</main>
