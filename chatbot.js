(function(){
  ...
  function ensureUI(){
    ...
    if(!launcher) {
      ...
      launcher.innerHTML='<div class="robot-container"><div class="robot-arm left"></div><div class="robot-head"><div class="robot-screen"><div class="robot-eye left"></div><div class="robot-eye right"></div></div></div><div class="robot-torso"></div><div class="robot-arm right"></div></div>';
