...
/**
 * React shell for Delivery Notes list.
 */
...
if ($assets === null) {
    ...
    echo '<!DOCTYPE html><html><head><title>Delivery Notes</title></head><body style="font-family:sans-serif;padding:2rem;">';
    echo '<h1>Delivery Notes</h1>';
...
$initPayload = deliveries_load_delivery_notes_payload($pdo, $_GET);
...
$employeeHeaderTitle = 'Delivery Notes';
...
$createNoteUrl = (string) ($initData['urls']['createNote'] ?? deliveries_module_url('deliveries/create_delivery_note.php'));
$employeeHeaderRightHtml = '<a href="' . htmlspecialchars($createNoteUrl, ENT_QUOTES, 'UTF-8') . '" class="dlv-header-create-btn">'
...
<body class="dashboard page-dlv-notes">
<?php
$rootPath = '/';
$logoBase = '/';
