...
<body class="dashboard">
    ...
    <main class="main-content">
        <div class="header-row" style="display:flex; justify-content:space-between; align-items:center; margin-bottom: 20px;">
            <div>
                <h1 style="font-size: 20px; color: #111827; margin:0;">Trips & Manifests</h1>
                        ...
                        <?php foreach($trips as $trip): ?>
                            <tr>
                                ...
                                <td style="text-align:right;">
                                    <?php if($trip['status'] == 'planned' || $trip['status'] == 'loading'): ?>
                                        <a href="manifest.php?trip_id=<?= $trip['id'] ?>" class="btn-outline">Manifest</a>
                                    <?php endif; ?>
