...
/**
 * ERP entry for Driver KPI ? erp-laravel Domains/DriverKpi + React UI.
 * Legacy JSON API remains at driver-kpi/api/index.php.
 */
...
$_SESSION['active_module'] = 'driver_kpi';
...
$GLOBALS['ERP_CONTEXT'] = $GLOBALS['ERP_DRIVER_KPI_CONTEXT'];
$GLOBALS['ERP_CONTEXT']['module'] = 'driver_kpi';
...
$GLOBALS['ERP_ROUTE'] = '/driver-kpi';
$GLOBALS['ERP_DRIVER_KPI_ROUTE'] = $GLOBALS['ERP_ROUTE'];
