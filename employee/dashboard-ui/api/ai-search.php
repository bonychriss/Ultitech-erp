<?php
/**
 * AI-assisted search for the employee Dashboard vouchers list.
 ...
 * Mirrors employee/vouchers-ui/api/ai-search.php.
 */
...
try {
    ...
    error_log('employee/dashboard-ui/api/ai-search.php failed: ' . $e->getMessage());
