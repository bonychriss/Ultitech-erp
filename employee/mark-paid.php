...
try {
    ...
    // Verify voucher exists and fetch all required metadata for Balances
    ...
    $redirectUrl = 'view-voucher.php?id=' . $voucher_id . '&paid=1&deducted=' . $amount . '&balance=' . $newBal . '&currency=' . urlencode($currency);
