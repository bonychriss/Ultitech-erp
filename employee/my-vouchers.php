...
<head>
    ...
    <style>
        ...
        body.dashboard .header.employee-header .theme-toggle-btn:not(.theme-toggle-glass) {
            width: 36px;
            height: 36px;
            flex-shrink: 0;
        }
        body.dashboard .header.employee-header .theme-toggle-btn.theme-toggle-glass {
            width: auto;
            height: auto;
            flex-shrink: 0;
        }
