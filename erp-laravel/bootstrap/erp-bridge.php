 ...
 * Expects $GLOBALS['ERP_CONTEXT'] / ERP_SALES_CONTEXT / ERP_SUGGEST_CONTEXT / ERP_STOCK_CONTEXT / ERP_PAYROLL_CONTEXT / ERP_LETTER_CONTEXT / ERP_ADMIN_CONTEXT / ERP_CASHBOOK_CONTEXT / ERP_ACCOUNTING_CONTEXT / ERP_REVENUE_CONTEXT / ERP_ATTENDANCE_CONTEXT / ERP_NOTIFICATIONS_CONTEXT / ERP_DELIVERIES_CONTEXT / ERP_DRIVER_KPI_CONTEXT / ERP_VOUCHER_CONTEXT
...
$route = (string) (
    ...
    ?? $GLOBALS['ERP_ACCOUNTING_ROUTE']
    ?? $GLOBALS['ERP_REVENUE_ROUTE']
    ?? $GLOBALS['ERP_ATTENDANCE_ROUTE']
    ?? $GLOBALS['ERP_NOTIFICATIONS_ROUTE']
    ?? $GLOBALS['ERP_DELIVERIES_ROUTE']
    ?? $GLOBALS['ERP_DRIVER_KPI_ROUTE']
    ?? $GLOBALS['ERP_VOUCHER_ROUTE']
    ?? '/api/dashboard'
);
