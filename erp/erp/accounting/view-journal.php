...
<div class="page-wrapper">
    ...
    <div class="container" style="background: white; max-width: 800px; margin: 0 auto; padding: 40px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
        <div class="header" style="text-align: center; margin-bottom: 30px; border-bottom: 2px solid #f1f3f4; padding-bottom: 20px;"><h1>Journal Entry</h1><p><?= htmlspecialchars($journal['entry_number']) ?> - <?= date('M d, Y', strtotime($journal['date'])) ?></p><p><?= htmlspecialchars($journal['description'] ?? '') ?></p></div>
