...
<body class="dashboard">
    ...
    <main class="main-content">
        ...
        <div class="actions">
            ...
            <a href="../erp/index.php" class="btn" style="background: #1a73e8; color: white;">📊 ERP System</a>
        </div>
            ...
            <table class="data-table recent-employee">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="view-voucher.php?id=<?= (int)$v['id'] ?>" class="icon-link icon-neutral" title="View" aria-label="View voucher">
                                <svg class="icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M12 5c-7.633 0-11 7-11 7s3.367 7 11 7 11-7 11-7-3.367-7-11-7zm0 12a5 5 0 110-10 5 5 0 010 10zm0-2.5a2.5 2.5 0 100-5 2.5 2.5 0 000 5z"/></svg>
                            </a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
