        ...
        <form id="createQuoteForm">
            ...
            <div class="page-header">
                ...
                <div class="header-actions">
                    ...
                    <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Save Quotation</button>
                </div>
            </div>
            ...
            <div class="top-grid">
                ...
                <!-- Quote Details Card -->
                <div class="card">
                    <div class="card-header-title">Quotation Details</div>
                    <div class="card-body">
                ...
                <div class="notes-section">
                    <div class="card" style="height: auto;">
                        <div class="card-body">
                            ...
                            <textarea name="notes" rows="4" placeholder="Enter terms and conditions..."></textarea>
                        </div>
                    </div>
                </div>
