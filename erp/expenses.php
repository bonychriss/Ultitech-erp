...
<div class="page-wrapper">
    <div style="padding: 16px 24px 0; text-align: right;"><div class="header-actions"><a href="../index.php" class="btn btn-secondary">← Back</a><a href="create-expense.php" class="btn btn-primary">+ Record Expense</a></div></div>
