...
<head>
    ...
    <title>New Sales Order - ERP</title>
        ...
        <form id="createOrderForm">
            ...
            <div class="page-header">
                ...
                <div class="header-actions">
                    <a href="sales-orders.php" class="btn btn-secondary">Cancel</a>
                    <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Save Sales Order</button>
                </div>
            </div>
            ...
            <div class="top-grid">
                ...
                <!-- Order Details Card -->
                <div class="card">
                    <div class="card-header-title">Order Details</div>
                    <div class="card-body">
                ...
                <div class="notes-section">
                    <div class="card" style="height: auto;">
                        <div class="card-body">
                            ...
                            <textarea name="notes" rows="4" placeholder="Enter delivery instructions or terms..."></textarea>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        document.getElementById('createOrderForm').addEventListener('submit', async function(e) {
            ...
            try {
                ...
                // Pointing to the new API endpoint
                const response = await fetch('../api/sales_orders.php', {
                    method: 'POST',
                    body: formData
                });
                ...
                if (result.success) {
                    window.location.href = 'view-sales-order.php?id=' + result.id;
                } else {
