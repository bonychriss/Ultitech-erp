<?php require_once '../../includes/functions.php'; requireLogin(); global $pdo; $accounts = $pdo->query("SELECT * FROM erp_accounts WHERE type = 'expense' ORDER BY name")->fetchAll(); ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
