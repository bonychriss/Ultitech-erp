<?php require_once '../../includes/functions.php'; requireLogin(); global $pdo; $accounts = $pdo->query("SELECT * FROM erp_accounts ORDER BY code")->fetchAll(); ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="header"><h1>New Journal Entry</h1><a href="journal-entries.php" class="btn btn-secondary">Cancel</a></div>
