<?php require_once '../../includes/functions.php'; requireLogin(); global $pdo; $journals = $pdo->query("SELECT * FROM erp_journal_entries ORDER BY date DESC LIMIT 50")->fetchAll(); ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="header"><h1>ðŸ“’ Journal Entries</h1><div class="header-actions"><a href="../index.php" class="btn btn-secondary">â† Back</a><a href="create-journal.php" class="btn btn-primary">+ New Journal Entry</a></div></div>
