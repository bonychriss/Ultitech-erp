...
<head>
    ...
    <style>* { margin: 0; padding: 0; box-sizing: border-box; } body { background: #f5f5f5; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Arial, sans-serif; } .header { background: #fff; border-bottom: 1px solid #e0e0e0; padding: 16px 24px; display: flex; justify-content: space-between; align-items: center; } .header h1 { font-size: 1.5rem; font-weight: 500; } .container { max-width: 800px; margin: 0 auto; padding: 24px; } .card { background: white; border-radius: 8px; border: 1px solid #e0e0e0; overflow: hidden; padding: 24px; } .section { margin: 20px 0; } .section-title { font-weight: 600; font-size: 1.1rem; margin-bottom: 12px; color: #1a73e8; border-bottom: 2px solid #f1f3f4; padding-bottom: 8px; } .line-item { display: flex; justify-content: space-between; padding: 8px 0; } .subtotal { font-weight: 600; background: #f8f9fa; padding: 12px; margin: 12px 0; display: flex; justify-content: space-between; } .net-income { background: #e8f0fe; padding: 20px; margin-top: 20px; display: flex; justify-content: space-between; font-size: 1.2rem; font-weight: 700; color: #1a73e8; } .btn { padding: 8px 16px; border-radius: 4px; text-decoration: none; font-size: 0.875rem; font-weight: 500; cursor: pointer; border: none; display: inline-block; } .btn-secondary { background: #fff; color: #202124; border: 1px solid #dadce0; }</style>
</head>
<body>
    <div class="header"><h1>ðŸ“ˆ Profit & Loss Statement</h1><div class="header-actions"><a href="../index.php" class="btn btn-secondary">â† Back</a></div></div>
