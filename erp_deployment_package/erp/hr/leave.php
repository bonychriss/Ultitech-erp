...
<body>
    <div class="header"><h1>ðŸ–ï¸ Leave Requests</h1><div class="header-actions"><a href="../index.php" class="btn btn-secondary">â† Back</a><a href="request-leave.php" class="btn btn-primary">+ Request Leave</a></div></div>
