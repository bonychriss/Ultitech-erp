...
// Generate next SKU
$stmt = $pdo->query("SELECT sku FROM erp_products ORDER BY id DESC LIMIT 1");
$lastSku = $stmt->fetchColumn();

if ($lastSku) {
    $num = intval(substr($lastSku, 4)) + 1;
    $nextSku = 'PROD-' . str_pad($num, 4, '0', STR_PAD_LEFT);
} else {
    $nextSku = 'PROD-0001';
}
?>
                ...
                <form id="createProductForm">
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="sku" value="<?= $nextSku ?>" readonly style="background: #f8f9fa;">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="stock_quantity" value="0" step="0.01" min="0">
                        </div>
                        
                        <div class="form-group">
                            <label>Reorder Level</label>
                            <input type="number" name="reorder_level" value="10" step="0.01" min="0">
                        </div>
                        
                        <div class="form-group full-width">
                            <label>Barcode</label>
                            <input type="text" name="barcode" placeholder="Scan barcode here...">
                        </div>
                    </div>
        ...
        document.getElementById('createProductForm').addEventListener('submit', async function(e) {
            ...
            try {
                ...
                if (result.success) {
                    ...
                    alert.textContent = 'Product created successfully! Redirecting...';
