        ...
        <form id="invoiceForm">
                ...
                <div class="card-body">
                    <div class="form-row">
                        ...
                        <div class="col">
                            ...
                            <input type="text" name="invoice_number" value="<?= $nextInv ?>" readonly style="background: #f8f9fa;">
                        </div>
                        <div class="col">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <button type="button" class="btn btn-secondary" onclick="addItem()">+ Add Line Item</button>
                    ...
                    <div class="totals-area">
                        <div class="totals-box">
                            ...
                            <div class="total-row">
                                <span>Tax Rate (%):</span>
                                <input type="number" name="tax_rate" id="taxRate" value="0" min="0" max="100" style="width: 60px; padding: 4px;" onchange="calculateTotals()">
                            </div>
                            <div class="total-row">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-group">
                        <label>Notes</label>
                        <textarea name="notes" rows="3" placeholder="Payment terms, delivery notes, etc."></textarea>
                    </div>
