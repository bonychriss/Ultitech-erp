...
try {
    global $pdo;
    if (!isset($pdo)) {
        die("PDO connection not established. Check config.php via functions.php");
    }
    ...
    echo "<h3>Database Error detected in Debug Mode:</h3>";
    echo "<pre>" . $e->getMessage() . "</pre>";
    $active_meetings = [];
} catch (Exception $e) {
    echo "<h3>General Error caught:</h3>";
    echo "<pre>" . $e->getMessage() . "</pre>";
    $active_meetings = [];
}
?>
...
<head>
    ...
    <title>DEBUG Meeting Lobby - <?= COMPANY_NAME ?></title>
...
<body>
    ...
    <div class="lobby-container">
        <header class="header">
            <h1 style="color: #f87171;">Lobby DEBUG Mode</h1>
