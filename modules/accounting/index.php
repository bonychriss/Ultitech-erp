...
<style>
    ...
    .acct-card { background:#fff; border:1px solid #e5e7eb; border-radius:12px; padding:14px; text-decoration:none; color:#0f172a; display:block; }
...
<main class="main-content acct-shell">
    <div class="acct-top">
        <div>
            ...
            <p class="acct-sub">Balances, revenue, journals, and reports in one place.</p>
        </div>
    </div>

    <section class="acct-grid">
        <a class="acct-card" href="/modules/balances/index.php?module=balances">
        ...
        <a class="acct-card" href="/revenue.php?module=revenue">
        ...
        <a class="acct-card" href="/modules/expenses/index.php?module=expenses">
            <div class="acct-ico c5"><i class="fas fa-receipt"></i></div>
            <div class="acct-h">Expenses</div>
            <p class="acct-p">Record and manage expense vouchers and payees.</p>
        </a>

        <a class="acct-card" href="/accounting/journal-entries.php?module=accounting">
        ...
        <a class="acct-card" href="/accounting/settings.php?module=accounting">
            <div class="acct-ico c5"><i class="fas fa-sliders"></i></div>
            <div class="acct-h">Accounting Settings</div>
            <p class="acct-p">Default sales revenue account and other GL posting defaults.</p>
        </a>

        <a class="acct-card" href="/accounting/journal-configuration.php?module=accounting">
            <div class="acct-ico c5"><i class="fas fa-gear"></i></div>
            <div class="acct-h">Journal Configuration</div>
            <p class="acct-p">Configure journal settings and posting rules.</p>
        </a>

        <a class="acct-card" href="/accounting/trial-balance.php?module=accounting">
        ...
        <a class="acct-card" href="/accounting/reconciliation.php?module=accounting">
