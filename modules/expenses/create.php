<?php
/**
 * Record expense — React shell.
 * modules/expenses/create.php
 */
...
$employeeHeaderTitle = 'Record Expense';
...
if ($assets === null) {
    ...
    echo '<!DOCTYPE html><html><head><title>Record Expense</title></head><body style="font-family:sans-serif;padding:2rem;">';
    echo '<h1>Record Expense</h1>';
