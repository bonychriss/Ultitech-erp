...
if ($assets === null) {
    ...
    echo '<!DOCTYPE html><html><head><title>Expenses</title></head><body style="font-family:sans-serif;padding:2rem;">';
    echo '<h1>Expenses</h1>';
