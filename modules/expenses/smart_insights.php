<?php
/**
 * Expenses Smart Insights — React shell.
 * modules/expenses/smart_insights.php
 */
...
$employeeHeaderTitle = 'Smart Insights';
$hideHeaderCompanyBranding = true;
$employeeHeaderExtraClass = 'employee-header--exp-desk';
$bodyExtraClass = 'page-exp-desk';
$expensesPage = 'insights';

$assets = expensesDeskLoadReactAssets();
if ($assets === null) {
    http_response_code(503);
    header('Content-Type: text/html; charset=utf-8');
    echo '<!DOCTYPE html><html><head><title>Smart Insights</title></head><body style="font-family:sans-serif;padding:2rem;">';
    echo '<h1>Smart Insights</h1>';
