<?php
/**
 * Shared React shell for Payroll module (matches expenses desk layout).
 *
 * Expects: $page_title, $employeeHeaderTitle, $payrollHeadMarkup,
 *          $assets (from payrollDeskLoadReactAssets), optional $payrollPage.
 */
$payrollPage = $payrollPage ?? 'dashboard';
...
<head>
    ...
    <?= payrollDeskShellHeadExtras() ?>
    <?= $payrollHeadMarkup ?>
</head>
<body class="dashboard page-pay-desk pay-dashboard-page">
...
body.page-pay-desk .employee-header--pay-desk::after {
...
<main class="main-content pay-desk-react-root">
    <noscript>
        <div style="padding:1rem;border:1px solid #fecaca;background:#fef2f2;color:#991b1b;border-radius:10px;">
            ...
            <p style="margin:0.35rem 0 0;">Enable JavaScript to use Payroll.</p>
        </div>
    </noscript>
    <div id="root"></div>
</main>
