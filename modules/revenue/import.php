<?php
/**
 * Import revenue  React shell.
 * modules/revenue/import.php
 */
...
$page_title = 'Import Revenue';
$employeeHeaderTitle = '';
$hideHeaderCompanyBranding = true;
$employeeHeaderExtraClass = 'employee-header--rev-desk';
$bodyExtraClass = 'page-rev-desk page-rev-import';
$revenuePage = 'import';
...
if ($assets === null) {
    ...
    echo '<!DOCTYPE html><html><head><title>Import Revenue</title></head><body style="font-family:sans-serif;padding:2rem;">';
    echo '<h1>Import Revenue</h1>';
