<?php
/**
 * Shared React shell for customer catalogue and customer view (exp-desk layout).
 */
$GLOBALS['_erp_header_style_linked'] = true;
$customersDeskPage = $customersDeskPage ?? 'catalogue';
$customersBodyClass = $customersBodyClass ?? 'page-customer-catalogue-desk';
$customersNoscriptMessage = $customersNoscriptMessage ?? 'Enable JavaScript to use this page.';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <?= customersDeskShellHeadExtras() ?>
    <?= $customersHeadMarkup ?>
</head>
<body class="dashboard page-exp-desk exp-dashboard-page <?= htmlspecialchars($customersBodyClass, ENT_QUOTES, 'UTF-8') ?>">
...
<main class="main-content exp-desk-react-root">
    <noscript>
        <div style="padding:1rem;border:1px solid #fecaca;background:#fef2f2;color:#991b1b;border-radius:10px;">
            ...
            <p style="margin:0.35rem 0 0;"><?= htmlspecialchars($customersNoscriptMessage) ?></p>
        </div>
    </noscript>
    <div id="root"></div>
</main>
