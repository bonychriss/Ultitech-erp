...
function sales_module_url(string $relativePath, array $query = []): string
{
    ...
    $deskMap = [
        ...
        'quote-requests/index.php' => 'sales/quote-requests',
        'quote-requests/' => 'sales/quote-requests',
        'quote-requests' => 'sales/quote-requests',
        ...
        'customers/catalogue.php' => 'sales/customer-catalogue',
        'customers/catalogue' => 'sales/customer-catalogue',
