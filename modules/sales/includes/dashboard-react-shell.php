<?php
/**
 * React shell for sales dashboard (exp-desk layout).
 */
...
<head>
    ...
    <?= dashboardDeskShellHeadExtras() ?>
    <?= $dashboardHeadMarkup ?>
</head>
<body class="dashboard sales-dashboard page-exp-desk exp-dashboard-page page-sales-dashboard-desk">
