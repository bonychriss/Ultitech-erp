...
/* Line items: fit card width — keep overflow visible for product dropdown */
body.page-inv-desk .inv-line-table-wrap {
    overflow: visible !important;
    width: 100%;
    max-width: 100%;
}
body.page-inv-desk .inv-line-table {
...
body.page-inv-desk .inv-line-table input,
body.page-inv-desk .inv-line-table select {
    min-width: 0 !important;
    max-width: 100%;
    box-sizing: border-box;
}
