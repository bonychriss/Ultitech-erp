function getApiBase() {
  if (typeof window !== 'undefined' && window.__PRICELIST_DESK_API_BASE__) {
    return String(window.__PRICELIST_DESK_API_BASE__).replace(/\/$/, '');
  }
  return './api';
}
...
export async function fetchPricelistInit(params = {}) {
