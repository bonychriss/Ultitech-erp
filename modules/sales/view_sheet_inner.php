            ...
            <table style="width: 100%; border: 1px solid #000; border-collapse: collapse; margin: 10px 0;">
                <tr>
                    ...
                    <td style="width: 33.33%; padding: 8px; border-right: 1px solid #ccc; vertical-align: top;">
                        ...
                        <div style="font-size: 11pt; color: #111;"><?php echo $invoice['due_date'] ? date('d/m/Y', strtotime($invoice['due_date'])) : '-'; ?></div>
                    </td>
                ...
                <table class="o-table" style="width: 100%; border-collapse: collapse; table-layout: fixed;">
                    <thead>
                        <tr style="background-color: #ffcc00;">
                            ...
                            <th style="width: 15%; padding: 10px; text-align: left; border-bottom: 2px solid #000; font-weight: normal;">PRODUCT</th>
                            <th style="padding: 10px; text-align: left; border-bottom: 2px solid #000; font-weight: normal;">DESCRIPTION</th>
                            <th style="width: 80px; padding: 10px; text-align: center; border-bottom: 2px solid #000; font-weight: normal;">QTY</th>
                            <th style="width: 210px; padding: 10px; text-align: right; border-bottom: 2px solid #000; font-weight: normal;">UNIT PRICE</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php foreach ($items as $item): ?>
                            <tr>
                                ...
                                <td style="width: 80px; text-align: center; padding: 10px; border-bottom: 1px solid #eee; vertical-align: middle;">

                                    <?php echo number_format($item['quantity'], 2); ?>
                                </td>
                                <td style="width: 210px; text-align: right; padding: 10px; border-bottom: 1px solid #eee; vertical-align: middle;">
            ...
            <div style="display: flex; justify-content: flex-end; margin-top: 20px;">
                <table class="o-totals-table">
                    ...
                    <tr class="o-totals-due">
                        <td>Amount Due:</td>
                        <td><?php echo ($invoice['currency'] ?? 'TZS') . ' ' . number_format($invoice['balance_due'], 2); ?></td>
                    </tr>
                </table>
            </div>
...
<?php
$salesDocTermsNumber = (string) ($invoice['invoice_number'] ?? ($invoice['quotation_number'] ?? ''));
$salesDocTermsTypeLabel = 'Quotation';
