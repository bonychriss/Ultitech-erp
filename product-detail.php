        ...
        <div class="row gx-5">
            ...
            <div class="col-md-5 mb-4">
                <div class="gallery-main mb-2">
                    <?php 
                        $mainImgSrc = 'assets/images/no-image.png';
                        if (!empty($images)) {
                            $mainImgSrc = "uploads/products/" . $product['id'] . "/large/" . $images[0]['image_name'];
                        }
                    ?>
                    <img src="<?php echo $mainImgSrc; ?>" id="mainImage" alt="Product Image">
                </div>
                
                <?php if(count($images) > 1): ?>
                <div class="gallery-thumbs">
                    <?php foreach($images as $index => $img): ?>
                    <div class="thumb-item <?php echo $index === 0 ? 'active' : ''; ?>" onclick="changeImage(this, '<?php echo "uploads/products/" . $product['id'] . "/large/" . $img['image_name']; ?>')">
                        <img src="uploads/products/<?php echo $product['id']; ?>/thumbnail/<?php echo $img['image_name']; ?>" alt="Thumbnail">
                    </div>
                    <?php endforeach; ?>
                </div>
                <?php endif; ?>
