<?php
/**
 * Sales React shell with ERP native sidebar (header_employee).
 * Expects: $page_title, $employeeHeaderTitle, $employeeHeaderExtraClass,
 *          $hideHeaderCompanyBranding, $dashboardHeadMarkup, $assets
 */
...
<head>
    ...
    <title><?= htmlspecialchars((string) $page_title) ?> - ERP</title>
    <script>
    (function() {
...
<body class="dashboard sales-dashboard page-exp-desk exp-dashboard-page page-sales-dashboard-desk page-sales-laravel">
...
<main class="main-content exp-desk-react-root">
    <noscript>
        <div style="padding:1rem;border:1px solid #fecaca;background:#fef2f2;color:#991b1b;border-radius:10px;">
            ...
            <p style="margin:0.35rem 0 0;">Enable JavaScript to view the sales dashboard.</p>
        </div>
    </noscript>
    <div id="root"></div>
</main>
