...
<body>
            ...
            <div class="header-inner" style="display: flex; justify-content: flex-start; align-items: center; width: 100%;">
                    ...
                    <div class="d-inline-flex align-items-center gap-1">
                        <details class="invoice-actions-desktop-dropdown" id="invoiceActionsDesktop">
                            ...
                            <div class="invoice-actions-desktop-panel">
                                ...
                                <a class="invoice-actions-desktop-item invoice-actions-desktop-item--payment" data-close-invoice-actions="1" href="../payments/create.php?invoice_id=<?php echo (int)$invoice['id']; ?>">
                ...
                <details class="order-actions-mobile action-bar-mobile-only" id="invoiceActionsMobile">
                    ...
                    <div class="order-actions-mobile-panel">
                        ...
                        <?php endif; ?>
                        <?php if ($invoice['status'] !== 'paid' && $invoice['status'] !== 'draft'): ?>
                        <a class="order-actions-mobile-item fw-semibold" style="color:#008784;" data-close-invoice-actions="1" href="../payments/create.php?invoice_id=<?php echo (int)$invoice['id']; ?>">
    ...
    <script>
        ...
        /** Narrowest invoice DOM node for rasterizing (avoid full-column whitespace in PDF). */
        function invoicePdfCaptureRoot() {
            const wrap = document.getElementById('invoice-content');
            if (!wrap) {
                return null;
            }
            return wrap.querySelector('.sheet-container')
                || wrap.querySelector('.spare-sheet')
                || wrap.querySelector('.truck-sheet')
                || wrap;
        }
        ...
        async function generateAndSendPdf(targetUrl) {
            ...
            try {
                ...
                const invoiceCanvas = await invoicePdfElementToCanvas(invoicePdfCaptureRoot());
                appendRasterCanvasToPdf(doc, invoiceCanvas, 0.93);
