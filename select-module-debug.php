...
<body>
    ...
    <div class="app-container">
        <div class="app-grid">
            ...
            <!-- Smart Pricing (Integrated with Tracking) -->
            <a href="order-tracking/index.php?module=pricing" class="app-item">
                <div class="app-icon-box bg-purple" style="background-color: #f3e8ff; color: #7e22ce;">
                ...
                <span class="app-label">Deal Feedback</span>
                <span class="app-desc">Integrated Tracking</span>
            </a>

            <!-- Smart Pricing Engine (NEW STANDALONE) -->
            <a href="smart_pricing_engine/index.php?module=pricing_engine" class="app-item">
                <div class="app-icon-box" style="background-color: #111827; color: #fbbf24;">
                    <svg class="app-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path>
                        <circle cx="12" cy="12" r="10" stroke-dasharray="4 4"></circle>
                    </svg>
                </div>
                <span class="app-label">Pricing Engine</span>
                <span class="app-desc">Landed Cost & Simulation</span>
            </a>
