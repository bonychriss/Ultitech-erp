    ...
    <script>
        window.__STOCK_PAGE__ = <?= json_encode([
            ...
            'data' => [
                ...
                'links' => [
                    'products' => function_exists('stock_desk_url') ? stock_desk_url('products') : ($base . 'modules/products/index.php'),
                    'products_low' => function_exists('stock_desk_url') ? stock_desk_url('products', ['filter' => 'low_stock']) : ($base . 'modules/products/index.php?filter=low_stock'),
                    'add_product' => function_exists('stock_desk_url') ? stock_desk_url('product-create') : ($base . 'modules/products/add.php'),
                    'purchases' => function_exists('stock_desk_url') ? stock_desk_url('purchases') : ($base . 'modules/purchases/index.php'),
                    'purchase_create' => function_exists('stock_desk_url') ? stock_desk_url('purchase-create') : ($base . 'modules/purchases/domestic_create.php'),
                    'suppliers' => function_exists('stock_desk_url') ? stock_desk_url('suppliers') : ($base . 'modules/suppliers/index.php'),
                    'shipments' => function_exists('stock_desk_url') ? stock_desk_url('shipments') : ($base . 'modules/shipments/index.php'),
                    'movements' => function_exists('stock_desk_url') ? stock_desk_url('movements') : ($base . 'modules/stock/movements.php'),
                    'uploads' => function_exists('stock_desk_url') ? stock_desk_url('uploads') : ($base . 'modules/uploads/index.php'),
                    'product_view' => function_exists('stock_desk_url') ? (rtrim(stock_desk_url('product-view'), '/') . '?id=') : ($base . 'modules/products/view.php?id='),
                    'purchase_view' => function_exists('stock_desk_url') ? (rtrim(stock_desk_url('purchase-view'), '/') . '?id=') : ($base . 'modules/purchases/view_po.php?id='),
                ],
            ],
