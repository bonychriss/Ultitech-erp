...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        $stmt = $pdo->prepare("INSERT INTO shippers (name, contact_person, email, phone, website, service_type, currency, average_delivery_days, reliability_score, cost_per_kg, cost_per_cbm) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
        if ($stmt->execute([$name, $contact_person, $email, $phone, $website, $service_type, $currency, $average_delivery_days, $reliability_score, $cost_per_kg, $cost_per_cbm])) {
            flash('success', 'Logistics Partner registered: ' . $name);
            redirect('index.php');
        }
    } catch (Exception $e) {
...
$page_title = 'Register Logistics Partner';
    ...
    <div class="max-w-[1200px] mx-auto px-8 py-10">
        ...
        <div class="flex items-center justify-between mb-10">
            <div class="flex items-center gap-5">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-slate-900 tracking-tight">Register Partner</h1>
                    <p class="text-xs text-slate-500 mt-1 tracking-widest opacity-60">Initialize new logistics & freight relationship</p>
                </div>
            </div>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" class="input-premium" placeholder="e.g. Global Freight Solutions" required>
                        </div>

                        <div>
                            <label class="label-premium">Official Website</label>
                            <input type="text" name="website" class="input-premium" placeholder="e.g. www.company.com">
                        </div>

                        <div>
                            <label class="label-premium">Contact Person</label>
                            <input type="text" name="contact_person" class="input-premium" placeholder="Primary liaison name">
                        </div>

                        <div class="grid grid-cols-1 gap-4">
                            <div>
                                <label class="label-premium">Business Email</label>
                                <input type="email" name="email" class="input-premium" placeholder="logistics@company.com">
                            </div>
                            <div>
                                <label class="label-premium">Phone / Mobile</label>
                                <input type="text" name="phone" class="input-premium" placeholder="Int. format">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <select name="service_type" class="input-premium">
                                ...
                                <option value="road">Road / Ground</option>
                        ...
                        <div>
                            ...
                            <input type="number" name="average_delivery_days" class="input-premium" value="30">
                        </div>

                        <div>
                            <label class="label-premium">Reliability Score (1.0 - 5.0)</label>
                            <input type="number" step="0.1" max="5" name="reliability_score" class="input-premium" value="5.0">
                        </div>
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" step="0.01" name="cost_per_kg" class="input-premium" value="0.00">
                            </div>
                            <div>
                                <label class="label-premium">Rate / CBM</label>
                                <input type="number" step="0.01" name="cost_per_cbm" class="input-premium" value="0.00">
                            </div>
                        </div>
...
document.querySelectorAll('.input-premium').forEach(el => {
    const markDirty = () => {
        if (el.value !== "" && el.value !== "0.00" && el.value !== "5.0" && el.value !== "30") {
