        ...
        <div class="row g-2 mb-4">
            <div class="col-6 col-md-3">
                <div class="card bg-primary text-white h-100 border-0 shadow-sm rounded-0">
                    <div class="card-body stat-card-body py-3">
                        <h6 class="text-uppercase stat-card-title small mb-2 opacity-75">Active Shipments</h6>
                        <h2 class="fw-bold stat-card-value mb-0"><?php echo $stats['active_shipments']; ?></h2>
                    </div>
                </div>
            </div>
            <div class="col-6 col-md-3">
                <div class="card bg-info text-dark h-100 border-0 shadow-sm rounded-0">
                    <div class="card-body stat-card-body py-3">
                        <h6 class="text-uppercase stat-card-title small mb-2 opacity-75">Volume YTD (CBM)</h6>
                        <h2 class="fw-bold stat-card-value mb-0"><?php echo $stats['total_cbm']; ?> m³</h2>
                    </div>
                </div>
            </div>
            <div class="col-6 col-md-3">
                <div class="card bg-warning text-dark h-100 border-0 shadow-sm rounded-0">
                    <div class="card-body stat-card-body py-3">
                        <h6 class="text-uppercase stat-card-title small mb-2 opacity-75">Missing ECC</h6>
                        <h2 class="fw-bold stat-card-value mb-0"><?php echo $stats['ecc_pending']; ?></h2>
                    </div>
                </div>
            </div>
             <div class="col-6 col-md-3">
                <div class="card bg-success text-white h-100 border-0 shadow-sm rounded-0">
                    <div class="card-body stat-card-body py-3">
                        <h6 class="text-uppercase stat-card-title small mb-2 opacity-75">Avg Transit Time</h6>
                        <h2 class="fw-bold stat-card-value mb-0"><?php echo !empty($transitTimeData) ? round(array_sum($transitTimeData)/count($transitTimeData)) : 0; ?> days</h2>
                    </div>
                </div>
            </div>
        </div>
