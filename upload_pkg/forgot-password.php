        ...
        <div class="auth-card">
            ...
            <form method="post">
                ...
                <div class="form-row">
                    ...
                    <input class="input" type="email" id="email" name="email" required placeholder="Auto-filled from User Directory" readonly style="background-color: #f3f4f6; cursor: not-allowed;">
                </div>
